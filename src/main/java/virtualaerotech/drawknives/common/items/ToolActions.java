...
public class ToolActions
{
    ...
    /**
     *  Passed onto {@link IForgeBlock#getToolModifiedState} when a draw knife wants to strip a log
     */
    public static final ToolAction DRAW_KNIFE_STRIP = ToolAction.get("draw_knife_strip");

    /**
     *  Passed onto {@link IForgeBlock#getToolModifiedState} when a draw knife wants to scrape oxidization off copper
     */
    public static final ToolAction DRAW_KNIFE_SCRAPE = ToolAction.get("draw_knife_scrape");

    /**
     *  Passed onto {@link IForgeBlock#getToolModifiedState} when a draw knife wants to remove wax out of copper
     */
    public static final ToolAction DRAW_KNIFE_WAX_OFF = ToolAction.get("draw_knife_wax_off");
    ...
    public static final Set<ToolAction> DEFAULT_AXE_ACTIONS = of(AXE_DIG);
    ...
    public static final Set<ToolAction> DEFAULT_DRAW_KNIFE_ACTIONS = of(DRAW_KNIFE_STRIP, DRAW_KNIFE_SCRAPE, DRAW_KNIFE_WAX_OFF);
